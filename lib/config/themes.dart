...
abstract class ZazzyThemes {
  ...
  static bool isThreeColumnMode(BuildContext context) =>
      MediaQuery.of(context).size.width > ZazzyThemes.columnWidth * 3.5;
  ...
  static ThemeData buildTheme(
    ...
    final isColumnMode = ZazzyThemes.isColumnMode(context);
    return ThemeData(
      ...
      snackBarTheme: isColumnMode
          ? const SnackBarThemeData(
              ...
              width: ZazzyThemes.columnWidth * 1.5,
            )
