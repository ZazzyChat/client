// /lib/widgets/zazzy_chat_app.dart
...
class ZazzyChatApp extends StatelessWidget {
  ...
  static final GoRouter router = GoRouter(
    ...
    redirect: (context, state) {
      final uri = state.uri;
      // если Android подкинул кастомный интент вида im.zazzychat://...
      if (uri.scheme == 'im.zazzychat') {
        debugPrint('Ignored external deep link: $uri');
        return '/';
      }
      return null;
    },
